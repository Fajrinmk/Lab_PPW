...
from .views import index,add_friend,validate_npm,delete_friend,friend_list,get_friend_list,friend_information
...
urlpatterns = [
        ...
        url(r'^friend-list/info/(?P<friend_id>[0-9]+)/$', friend_information, name='info'),
]
